...
def test_load_train_data():
    ...
    train_loader = load_train_data(batch_size=16, num_workers=1)
...
def test_load_val_data():
    ...
    val_loader = load_val_data(batch_size=16, num_workers=1)
...
def test_load_test_data():
    ...
    test_loader = load_test_data(batch_size=16, num_workers=1)
